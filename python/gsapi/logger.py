...
def setDefaultLoggingLevel(level):
    ...
    Args:
        level: one of default python's logging levels: logging.[CRITICAL, ERROR, WARNING, INFO, DEBUG, NOTSET]
    """
    gsapiLogger.setLevel(level)


def setUseColoredOutput(useColor):
    """Enable or not colored console output.
    Powerful in the console, but annoying otherwise
    Args:
